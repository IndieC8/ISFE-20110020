<%-- 
    ...
    Created on : 1/02/2012, 11:12:10 AM
    Author     : kawatoto
--%>
...
<html>
	<head>
            <title>ISFE - Consultar Perfil</title>
	...
	<center>
		...
		<!-- Termina Menu -->
                <br><br>
		<div class="titulo_pagina">Consultar Perfil</div>
		<center>
                <!--Comienza el formulario-->	
		<div id="tabs">
                  <ul>
                     <li><a href="#tabs-1">Informaci&oacute;n Personal</a></li>
                     <li><a href="#tabs-2">Informaci&oacute;n Fiscal</a></li>
                  </ul>
		<div id="tabs-1">
