		...
		<div id="tabs">
			...
			<div id="tabs-1">
                            <form method="post" enctype="multipart/form-data" id="subirFIEL">
                              <input type="file" name="archivofiel" class="fileUpload" />
                              ...
                              <input type="reset" value="Cancelar FIEL" name="cancelarFIEL" class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false"/>
                            </form>
                        </div>
			<div id="tabs-2">
                           <form method="post" enctype="multipart/form-data" id="subirCSD">
                              <input type="file" name="archivocsd" class="fileUpload">
                              ...
                              <input type="reset" value="Cancelar CSD" name="cancelarCSD" class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false"/>
                           </form>
                        </div>
		</div>
                <br><br>
