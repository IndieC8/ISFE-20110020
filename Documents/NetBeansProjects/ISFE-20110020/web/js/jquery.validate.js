...
$.extend($.validator, {
	...
	messages: {
		...
		number: "Por favor, ingrese un numéro válido.",
		digits: "Por favor, ingrese sólo dígitos.",
		creditcard: "Por favor, ingrese un numéro de tarjeta de crédito válida.",
		...
		rangelength: $.validator.format("Por favor, ingrese un valor entre {0} y {1} de caracteres."),
